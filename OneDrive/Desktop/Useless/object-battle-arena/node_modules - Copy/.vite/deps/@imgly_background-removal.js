...
var require_ndarray = __commonJS({ "../../node_modules/.pnpm/ndarray@1.0.19/node_modules/ndarray/ndarray.js"(exports, module) {
	...
	function order() {
		...
		var i = 0;
		for (; i < terms.length; ++i) terms[i] = [Math.abs(stride[i]), i];
...
var getOrt = async (useWebGPU) => {
	...
	if (useWebGPU) ort = (await import("./ort.webgpu.bundle.min-ButBvB7i.js")).default;
	else ort = (await import("./ort.bundle.min-DIyHTpcR.js")).default;
	return ort;
};
